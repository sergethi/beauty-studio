...
const Discount = () => {
  return (
    <div>
      <Card
        className="z-0 h-auto w-full bg-[url('https://images.unsplash.com/photo-1500840216050-6ffa99d75160?q=80&w=1497&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')] bg-cover bg-center opacity-1 p-10"
        radius="none"
      >
