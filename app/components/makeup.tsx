...
const Makeup = () => {
  return (
    <div className="flex sm:flex-row-reverse flex-col w-full items-center justify-center sm:gap-28 gap-8 p-10">
      ...
      <div className="max-w-md">
        <p className="xs:text-3xl sm:text-6xl font-bold">We do makeup</p>
