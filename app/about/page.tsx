  ...
  return (
    <div className=" z-0 flex flex-col items-center justify-center max-w-full gap-8 mb-40">
      <div className="relative z-1 flex flex-shrink-0 flex-col items-center justify-center w-full max-w-6xl h-[50vh] text-center bg-[url('/images/salon-benyamin-bohlouli-unsplash.jpg')] bg-cover bg-center opacity-1">
        ...
        {/* Dark overlay */}
        <p className="z-10 xs:text-3xl sm:text-4xl md:text-5xl text-white font-bold">Who we are</p>
      </div>
      <div className=" z-10 max-w-6xl custm-pad lg:p-0">
      ...
      <p className="z-10 xs:text-3xl sm:text-6xl font-bold text-left max-w-6xl w-full custm-pad lg:p-0">
        Our team
      </p>
      <div className=" z-10 flex md:flex-row flex-col items-center justify-center max-w-6xl w-full gap-8 custm-pad lg:p-0">
        {team.map((member, index) => (
          <div key={index} className="flex flex-col gap-8 max-w-full">
            ...
            <b className="xs:text-2xl sm:text-3xl">{member.name}</b>
